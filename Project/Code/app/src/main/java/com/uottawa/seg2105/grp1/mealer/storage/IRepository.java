...
public interface IRepository {
     ...
     */
    public <T extends Entity> boolean hasId(String id);
     ...
     */
    public <T extends Entity> boolean set(T entity);
     ...
     */
    public <T extends Entity> boolean update(String id, Map<String, Object> props);
     ...
     */
    public <T extends Entity> List<T> query(Predicate<T> predicate);
}
